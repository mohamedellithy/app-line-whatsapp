...
class User{
    ...
    public function check_user_exist($data) {
        ...
        if($user):
            ...
            // message text
            $message = urlencode("
            شريكنا العزيز (".$user->username." 👋🏻

            نحن نود أن نعلمك بأن حسابك قد تم تفعيله بنجاح في منصتنا. نحن سعداء بانك عضو نشط في عائلتنا.
            https://wh.line.sa
            ...
            نحن نقدر ثقتك فينا ونتطلع إلى خدمتك بأفضل ما لدينا. إذا كان لديك أي أسئلة أو استفسارات، فلا تتردد في الاتصال بفريق الدعم لدينا. سنكون سعداء بمساعدتك وتقديم الدعم اللازم.

            شكرًا لانضمامك إلى منصتنا وثقتك في خدماتنا.
            مرة أخرى، نرحب بك بحرارة ونتمنى لك تجربة ممتعة ومثمرة معنا.


            مع خالص التحية،
            خدمة العملاء بواتساب لاين
            ");
        ...
        if($new_account):
            ...
            if($package):
                ...
                if($new_team):
                    ...
                    // message text
                    $message = urlencode("
                    شريكنا العزيز (".$new_account->username." 👋🏻

                    نحن نود أن نرحب بك كشريك جديد في عائلتنا. نحن نقدر ثقتك فينا ونتطلع إلى بناء علاقة قوية ومثمرة معك.
                    معنا انت لست عميل بل شريك نجاح لذلك من أولوياتنا نجاح اعمالك، ونسعى جاهدين لتقديم أفضل خدمة ممكنة. نحن ملتزمون بتلبية احتياجاتك وتحقيق أهدافك بطريقة فعالة ومحترفة.
                    ...
                    بعد انجاز الخطوات سيتم ربط الخدمة بمتجرك المتميز آليا :
                    ".$store_url."
                    ...
                    مرة أخرى، نرحب بك بحرارة ونتطلع إلى بدء رحلة ناجحة ومثمرة معًا.
